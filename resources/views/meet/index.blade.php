    ...
    <div id="meeting-index">
            ...
            <div class="content" id="tab-group-1">
                <div class="tab-controls tabs-small tabs-rounded" data-highlight="bg-highlight">
                    <a href="#" id="meeting-tab-1" data-active="" data-bs-toggle="collapse" data-bs-target="#tab-1"
                        class="bg-highlight no-click" aria-expanded="true"><i class="far fa-plus-square"></i>&nbsp;&nbsp;
                        Create</a>
                    <a href="#" id="meeting-tab-2" data-bs-toggle="collapse" data-bs-target="#tab-2" aria-expanded="false"
                        class="collapsed"><i class="fas fa-person-booth"></i>&nbsp;&nbsp; Join</a>
                    <a href="#" id="meeting-tab-3" data-bs-toggle="collapse" data-bs-target="#tab-3" aria-expanded="false"
                        class="collapsed"><i class="far fa-calendar-alt"></i>&nbsp;&nbsp; Schedule</a>
                </div>
                ...
                <div data-bs-parent="#tab-group-1" class="collapse show" id="tab-1" style="">
                    <form class="needs-validation" id="createMeetingForm" novalidate>
                        ...
                        <div class="input-style input-style-always-active has-borders has-icon mb-4">
                            ...
                            <input id="meetingName" type="name" class="form-control" placeholder="Enter meeting name"
                                required>
                        ...
                        <div class="d-flex no-effect collapsed" data-trigger-switch="toggle-id" data-bs-toggle="collapse"
                        ...
                        <div id="password_meeting" class="input-style input-style-always-active has-borders has-icon mb-4"
                            style="display:none">
                ...
                <div data-bs-parent="#tab-group-1" class="collapse" id="tab-3" style="">
                    ...
                    <form class="needs-validation" novalidate id="scheduleMeetingForm">
                        ...
                        <div id="password_meeting_schedule"
                            class="input-style input-style-always-active has-borders has-icon mb-4" style="display:none">
                            <i class="fas fa-key color-highlight"></i>
                            <input type="name" class="form-control" placeholder="Enter room password">
                            <label class="color-theme opacity-50 text-uppercase font-700 font-10">Password</label>
                            <em>(optional)</em>
        ...
        <div class="card card-style bg-theme pb-0">
            <div class="content" id="tab-group-2">
                <div class="tab-controls tabs-small tabs-rounded" data-highlight="bg-highlight">
                    <a href="#" id="meeting-schedule" data-active="" data-bs-toggle="collapse" data-bs-target="#schedule"
                        class="bg-highlight no-click" aria-expanded="true"><i class="far fa-calendar-alt"></i>&nbsp;&nbsp;
                        Schedule</a>
                    <a href="#" id="meeting-log" data-bs-toggle="collapse" data-bs-target="#log" aria-expanded="false"
                        class="collapsed"><i class="fas fa-stream"></i> &nbsp;&nbsp; Log</a>
                </div>
