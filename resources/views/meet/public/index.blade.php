                                ...
                                <div class="card card-style">
                                    <div class="content">
                                        ...
                                        <div class="input-style input-transparent no-borders has-icon validate-field">
                                            ...
                                            <input type="name" class="form-control validate-name" id="usrNameJoin" placeholder="Nick Name" required>
                                        ...
                                        <a href="#" id="join-meeting" class="btn btn-full btn-m shadow-large rounded-s text-uppercase font-900 bg-highlight">JOIN</a>
