...
{{-- <style>
  ...
  <div class="row" style="height:90%">
    ...
    <div class="col-md-8 col-lg-8 col-sm-12 d-none d-lg-block" style="height:82vh;overflow-y: scroll;">
  ...
  <div class="row">
    <div class="col-md-8 col-lg-8 col-sm-12 d-none d-lg-block offset-4">
